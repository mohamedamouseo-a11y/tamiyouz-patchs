 ...
 * Marker: TAMIYOUZ-HOMEPAGE-BRAND-LOCK-V2_3 | TAMIYOUZ-SERVICES-CONTENT-V1 | TAMIYOUZ-HOMEPAGE-VISUAL-GATE-POLISH-V2_9_9
 */
...
<head>
    ...
    <?php wp_head(); ?>
    <style id="tamiyouz-template-fail-open-v2-9-9">
      #tyz-home-v21 .tyz-reveal{opacity:1!important;transform:none!important;visibility:visible!important}
    </style>
</head>
<body <?php body_class(); ?>>
<?php wp_body_open(); ?>
    ...
    <div class="tyz-shell tyz-hero__grid">
        ...
        <div class="tyz-hero__visual tyz-reveal">
            <div class="tyz-hero__media">
                ...
                <div class="tyz-float tyz-float--three"><small>OPERATIONS</small><strong>متابعة وتشغيل أوضح</strong></div>
            </div>
        </div>
    </div>
...
<section class="tyz-about" id="about">
    <div class="tyz-shell tyz-about__grid">
        <div class="tyz-about__copy">
            ...
            <a class="tyz-button tyz-button--outline tyz-about__cta tyz-reveal" href="#services">اعرف المزيد <span>←</span></a>
        </div>
...
<section class="tyz-services" id="services">
    <div class="tyz-shell">
        ...
        <div class="tyz-service-grid">
            <article class="tyz-service tyz-reveal"><span>01</span><i class="tyz-service__icon" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M12 3l1.5 4.2L18 9l-4.5 1.8L12 15l-1.5-4.2L6 9l4.5-1.8L12 3Z"/><path d="M18.5 14.5l.8 2.2 2.2.8-2.2.8-.8 2.2-.8-2.2-2.2-.8 2.2-.8.8-2.2Z"/></svg></i><h3>حلول الذكاء الاصطناعي</h3><p>وكلاء أذكياء، بحث معرفي وأتمتة تساعد فريقك على العمل بذكاء أكبر.</p><a href="<?php echo esc_url(home_url('/services/ai-solutions/')); ?>">اكتشف المزيد ←</a></article>
            <article class="tyz-service tyz-reveal"><span>02</span><i class="tyz-service__icon" aria-hidden="true"><svg viewBox="0 0 24 24"><rect x="3" y="4" width="18" height="16" rx="3"/><path d="M3 9h18M8 14h4M8 17h7"/></svg></i><h3>البرمجيات والأنظمة</h3><p>أنظمة مخصصة، CRM ومنصات تشغيل مبنية حول احتياج عملك.</p><a href="<?php echo esc_url(home_url('/services/custom-software/')); ?>">اكتشف المزيد ←</a></article>
            <article class="tyz-service tyz-reveal"><span>03</span><i class="tyz-service__icon" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M5 4l13 6-6 2-2 6L5 4Z"/><path d="M13 13l5 5"/></svg></i><h3>التجارب الرقمية</h3><p>مواقع ومنتجات رقمية تجمع الوضوح بالأداء والتحويل.</p><a href="<?php echo esc_url(home_url('/services/web-design-development/')); ?>">اكتشف المزيد ←</a></article>
            <article class="tyz-service tyz-reveal"><span>04</span><i class="tyz-service__icon" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M4 18V9M10 18V6M16 18v-4M22 18H2"/><path d="M5 12l5-4 5 3 5-6"/></svg></i><h3>التسويق والنمو</h3><p>استراتيجية وأداء وقياس موحد يساعدك على اتخاذ قرارات أفضل.</p><a href="<?php echo esc_url(home_url('/services/performance-marketing/')); ?>">اكتشف المزيد ←</a></article>
            <article class="tyz-service tyz-reveal"><span>05</span><i class="tyz-service__icon" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M8 8h8v8H8z"/><path d="M4 12H2M22 12h-2M12 4V2M12 22v-2M5.6 5.6 4.2 4.2M19.8 19.8l-1.4-1.4M18.4 5.6l1.4-1.4M4.2 19.8l1.4-1.4"/></svg></i><h3>الأتمتة والتكاملات</h3><p>ربط الأدوات والعمليات لتقليل العمل المتكرر ورفع الكفاءة.</p><a href="<?php echo esc_url(home_url('/services/automation-integrations/')); ?>">اكتشف المزيد ←</a></article>
            <article class="tyz-service tyz-reveal"><span>06</span><i class="tyz-service__icon" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M4 19V5M4 19h16"/><path d="M7 15l4-4 3 2 5-6"/><circle cx="7" cy="15" r="1"/><circle cx="11" cy="11" r="1"/><circle cx="14" cy="13" r="1"/><circle cx="19" cy="7" r="1"/></svg></i><h3>البيانات والتحليلات</h3><p>لوحات وتقارير تربط الأداء بالتشغيل وتوضح أين تتحرك بعد ذلك.</p><a href="<?php echo esc_url(home_url('/services/data-analytics/')); ?>">اكتشف المزيد ←</a></article>
        </div>
    </div>
</section>
...
<section class="tyz-ai" id="ai">
    <div class="tyz-shell tyz-ai__grid">
        <div class="tyz-ai__copy tyz-reveal">
            ...
            <div class="tyz-ai__actions tyz-reveal">
                <a class="tyz-button" href="<?php echo esc_url(home_url('/services/ai-solutions/')); ?>">اكتشف حلول الذكاء <span>←</span></a>
                <a class="tyz-button tyz-button--outline" href="#contact">ابدأ مشروعك <span>←</span></a>
            </div>
        </div>
    ...
    <div class="tyz-shell">
        ...
        <div class="tyz-work-grid">
            <article class="tyz-work-card tyz-work-card--wide tyz-reveal">
                ...
                <div class="tyz-work-card__copy"><small>BUSINESS SOFTWARE</small><h3>منظومة CRM وتشغيل مخصصة</h3><p>واجهة واحدة للعملاء والمهام والمتابعة والأتمتة والبيانات.</p></div>
            </article>
