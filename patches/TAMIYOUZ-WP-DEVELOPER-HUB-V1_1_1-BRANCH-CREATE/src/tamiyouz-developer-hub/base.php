<?php
// Marker: TAMIYOUZ-WP-DEVELOPER-HUB-V1_1_1-BRANCH-CREATE
...
function tamiyouz_devhub_111_github_request($token, $method, $path, $body, $allow_404) {
    $args = array(
        ...
        'headers' => array(
            ...
            'Accept' => 'application/vnd.github+json',
            'X-GitHub-Api-Version' => '2022-11-28',
            'User-Agent' => 'Tamiyouz-WordPress-Developer-Hub/1.1.1'
        )
    );
    if ($body !== null) {
...
function tamiyouz_devhub_111_create_branch($token, $repo, $branch) {
    ...
    if (isset($source['__status']) && $source['__status'] === 404) {
        ...
        if (empty($tree['sha'])) {
            throw new Exception('Could not create the initial Git tree.');
        }
        ...
        if (empty($commit['sha'])) {
            throw new Exception('Could not create the initial Git commit.');
        }
        $source_sha = (string) $commit['sha'];
    } else {
...
<div class="wrap tyz-devhub103" dir="rtl">
    <h1>Developer Hub</h1>
    <p class="description">Developer Hub V1.1.1 — GitHub connection, repository verification and safe branch creation. Sync execution remains disabled.</p>
    ...
    <div class="tyz-grid">
        <div class="tyz-card">
            ...
            <p><strong>Write operations:</strong> Only explicit GitHub branch creation is enabled; Push/Pull/Sync execution stays disabled</p>
        </div>
    ...
    <div class="tyz-card">
        ...
        <p><span class="tyz-badge hold">RECOVERY HOLD</span></p>
        <p>Review Push / Pull / Sync will be enabled in V1.1 only after this safe bootstrap loads cleanly on the live PHP runtime.</p>
    </div>
</div>
<style>
