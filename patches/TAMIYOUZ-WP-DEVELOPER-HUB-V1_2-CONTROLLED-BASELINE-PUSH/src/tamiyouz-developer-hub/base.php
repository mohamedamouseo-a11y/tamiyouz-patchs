...
<div class="wrap tyz-devhub103" dir="rtl">
    <h1>Developer Hub</h1>
    <p class="description">Developer Hub V1.2 — safe branch creation plus reviewed baseline Push. Pull/Sync execution remains disabled.</p>
    ...
    <div class="tyz-grid">
        <div class="tyz-card">
            ...
            <p><strong>Write operations:</strong> Branch creation + reviewed baseline Push only; Pull/Sync execution stays disabled</p>
        </div>
    ...
    <div class="tyz-card">
        ...
        <p>V1.2 allows only an explicitly reviewed baseline Push to GitHub. Pull and Sync remain read-only.</p>
    </div>
</div>
<style>
