...
<div class="wrap tyz-devhub103" dir="rtl">
    <h1>Developer Hub</h1>
    <p class="description">Developer Hub V1.4 — safe baseline bootstrap + controlled Push with real progress. Pull/Sync execution remains disabled.</p>
    ...
    <div class="tyz-card">
        ...
        <p><span class="tyz-badge ok">REAL PUSH PROGRESS READY</span></p>
        <p>V1.4 safely adopts an existing matching remote baseline, then performs explicitly reviewed Push with real staged progress. Pull and Sync remain read-only.</p>
    </div>
</div>
<style>
