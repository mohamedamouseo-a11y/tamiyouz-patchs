 ...
 * Marker: TAMIYOUZ-HOMEPAGE-BRAND-LOCK-V2_3 | TAMIYOUZ-SERVICES-CONTENT-V1 | TAMIYOUZ-HOMEPAGE-REFERENCE-MATCH-V2_9_7
 */
...
<head>
    ...
    <?php wp_head(); ?>
    <style id="tamiyouz-template-fail-open-v2-9-7">
