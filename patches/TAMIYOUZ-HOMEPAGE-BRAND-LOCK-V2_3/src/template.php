 ...
 * Marker: TAMIYOUZ-HOMEPAGE-BRAND-LOCK-V2_3
 */
...
<section class="tyz-services" id="services">
    <div class="tyz-shell">
        ...
        <div class="tyz-service-grid">
            <article class="tyz-service tyz-reveal"><span>01</span><i>AI</i><h3>حلول الذكاء الاصطناعي</h3><p>وكلاء أذكياء، بحث معرفي وأتمتة تساعد فريقك على العمل بذكاء أكبر.</p><a href="#ai">اكتشف المزيد ←</a></article>
            <article class="tyz-service tyz-reveal"><span>02</span><i>SW</i><h3>البرمجيات والأنظمة</h3><p>أنظمة مخصصة، CRM ومنصات تشغيل مبنية حول احتياج عملك.</p><a href="#work">اكتشف المزيد ←</a></article>
            <article class="tyz-service tyz-reveal"><span>03</span><i>DX</i><h3>التجارب الرقمية</h3><p>مواقع ومنتجات رقمية تجمع الوضوح بالأداء والتحويل.</p><a href="#work">اكتشف المزيد ←</a></article>
            <article class="tyz-service tyz-reveal"><span>04</span><i>GR</i><h3>التسويق والنمو</h3><p>استراتيجية وأداء وقياس موحد يساعدك على اتخاذ قرارات أفضل.</p><a href="#contact">اكتشف المزيد ←</a></article>
            <article class="tyz-service tyz-reveal"><span>05</span><i>AT</i><h3>الأتمتة والتكاملات</h3><p>ربط الأدوات والعمليات لتقليل العمل المتكرر ورفع الكفاءة.</p><a href="#ai">اكتشف المزيد ←</a></article>
            <article class="tyz-service tyz-reveal"><span>06</span><i>DA</i><h3>البيانات والتحليلات</h3><p>لوحات وتقارير تربط الأداء بالتشغيل وتوضح أين تتحرك بعد ذلك.</p><a href="#ai">اكتشف المزيد ←</a></article>
        </div>
    </div>
</section>
