 ...
 * Marker: TAMIYOUZ-HOMEPAGE-BRAND-LOCK-V2_3 | TAMIYOUZ-SERVICES-CONTENT-V1 | TAMIYOUZ-HOMEPAGE-RENDERED-DELTA-FIX-V2_9_8
 */
...
<head>
    ...
    <?php wp_head(); ?>
    <style id="tamiyouz-template-fail-open-v2-9-8">
