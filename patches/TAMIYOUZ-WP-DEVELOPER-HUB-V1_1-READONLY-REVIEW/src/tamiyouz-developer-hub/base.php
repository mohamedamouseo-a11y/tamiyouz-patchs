...
<div class="wrap tyz-devhub103" dir="rtl">
    <h1>Developer Hub</h1>
    <p class="description">Safe Bootstrap 1.0.3 — GitHub connection and repository verification. Sync actions stay disabled until the bootstrap is verified stable.</p>
    ...
    <div class="tyz-grid">
        <div class="tyz-card">
            ...
            <p><strong>Write operations:</strong> Disabled in this recovery build</p>
        </div>
    ...
    <div class="tyz-card">
        ...
        <?php else : ?>
            <form method="post">
                <?php wp_nonce_field('tamiyouz_devhub_103'); ?>
                <input type="hidden" name="devhub_action" value="save_repo">
                ...
                <p><button class="button button-primary">Verify & Save</button></p>
            </form>
        <?php endif; ?>
