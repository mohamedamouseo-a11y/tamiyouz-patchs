...
VERSION="V3.1.8"
PATCH="TAMIYOUZ-HOMEPAGE-NATIVE-CARD-LIFT-V3_1_8"
...
patch_css=patch_dir/"native-card-lift.css"
patch_js=patch_dir/"native-card-lift.js"
...
print("V317_CARD_LAYER=SUPERSEDED")
print("NATIVE_CARD_CLONES=4")
print("NEW_LEADS_NATIVE_LIFT=ENABLED")
print("FOLLOW_UP_NATIVE_LIFT=ENABLED")
print("TIKTOK_NATIVE_LIFT=ENABLED")
print("INSTAGRAM_NATIVE_LIFT=ENABLED")
print("DEMO_READOUTS=ENABLED")
