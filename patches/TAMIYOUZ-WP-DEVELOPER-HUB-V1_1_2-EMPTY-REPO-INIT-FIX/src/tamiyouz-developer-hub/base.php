<?php
// Marker: TAMIYOUZ-WP-DEVELOPER-HUB-V1_1_2-EMPTY-REPO-INIT-FIX
...
<div class="wrap tyz-devhub103" dir="rtl">
    <h1>Developer Hub</h1>
    <p class="description">Developer Hub V1.1.2 — safe branch creation with empty-repository initialization. Sync execution remains disabled.</p>
